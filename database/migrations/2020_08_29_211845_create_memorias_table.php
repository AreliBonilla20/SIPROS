...
class CreateMemoriasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('memorias', function (Blueprint $table) {
            ...
            $table->unsignedInteger('docente_benef_m')->nullable();
            $table->unsignedInteger('docente_benef_f')->nullable();
            $table->unsignedInteger('personal_benef_m')->nullable();
            $table->unsignedInteger('personal_benef_f')->nullable();
            $table->unsignedInteger('estudiante_benef_m')->nullable();
            $table->unsignedInteger('estudiante_benef_f')->nullable();
            $table->unsignedInteger('otros_benef_m')->nullable();
            $table->unsignedInteger('otros_benef_f')->nullable();
