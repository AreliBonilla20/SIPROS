        ...
        <div class="carousel-inner" role="listbox">
          ...
          @foreach($avisos as $aviso)
            @if($ultimo->id==$aviso->id)
              ...
              <div class="carousel-item active" style="background-image: url('{{asset('assets/img/6660.jpg')}}') ">
                <div class="carousel-container">
                  <div class="carousel-content">
                    <div style="background-color:rgba(255, 255, 255, 0.3); border-radius: 25px; padding: 25px" class="col-md-12">
            ...
            @else
              ...
              <div class="carousel-item" style="background-image: url('{{asset('assets/img/6660.jpg')}}') ">
                <div class="carousel-container">
                  <div class="carousel-content">
                    <div style="background-color:rgba(255, 255, 255, 0.3); border-radius: 25px; padding: 25px" class="col-md-12">
                      <h2 class="animate__animated animate__fadeInDown">{{ $aviso->titulo }}</h2>
