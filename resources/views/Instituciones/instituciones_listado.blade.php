                ...
                <div class="data-table-list">
                    ...
                    <div class="col-10">
                        ...
                        <span class="input-group-btn" style="padding-left:74%;">
                                <a href="{{ route('instituciones') }}"><button type="submit" class="btn btn-danger notika-btn-danger" > <span class="glyphicon glyphicon-remove"></span> Limpiar búsqueda</button> </a>
                        </span>
                        @endif
                        ...
                        <table id="data-table-basic" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-default notika-btn-default" href="{{route('editar_institucion', $institucion->id)}}"><span class="glyphicon glyphicon-pencil"></span> Editar</a>
                                    </td>
                                    <td>
