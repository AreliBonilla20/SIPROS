                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list" style="padding:4%;">
                        ...
                        <div class="row" style="padding-left:35%;">
                            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                            <button type="button" style="color:white;" class="btn btn-info notika-btn-info btn-button-mg" data-toggle="modal" data-target="#asignacion"><span class="glyphicon glyphicon-check"></span> Asignar poyecto</button>
